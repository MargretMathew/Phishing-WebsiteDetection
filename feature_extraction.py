   ...
   # if re.match(r"^www.",domain):
    ...
    if re.match(r"^www.",domain):
        ...
        try:
            ...
            whois_response=""
        #whois_response = whois.whois(domain)
    # print("Whois responds: ", whois_response)
    rank_checker_response = requests.post("https://www.checkpagerank.net/index.php", {
       "name": domain
    })
    # print("Rankchecker: ",rank_checker_response)
    ...
    return data_set,whois_response,rank_checker_response,global_rank,url,domain
